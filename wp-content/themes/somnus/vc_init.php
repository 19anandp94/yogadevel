 ...
 * Whoop-dee-doo
 */
get_template_part('vc_blocks/vc_section_title_block');
get_template_part('vc_blocks/vc_featured_text_block');
get_template_part('vc_blocks/vc_instagram_block');
get_template_part('vc_blocks/vc_testimonial_block');
get_template_part('vc_blocks/vc_team_block');
get_template_part('vc_blocks/vc_timetable_block');
get_template_part('vc_blocks/vc_workshop_block');